...
#define __W25Q64__SPI__Reference__
    ...
    void W25Q64_WriteEnable(void){
        ...
        SPI_Register_Write_Read(W25X_WriteEnable);
...
#define __Map__SPI__Reference__
    ...
    void SPI_1_Read(uint8_t* input_Pointer, uint16_t ReadSize, uint32_t ReadAddress){
        SPI_APP_Buffer_Read(SPI_Class_1, uint8_t* input_Pointer, uint16_t ReadSize, uint32_t ReadAddress);
    }
    void SPI_1_Write(uint8_t* input_Pointer, uint16_t WriteSize, uint32_t WriteAddress){
        SPI_APP_Buffer_Write(SPI_Class_1, uint8_t* input_Pointer, uint16_t WriteSize, uint32_t WriteAddress);
    }

    void SPI_2_Read(uint8_t* input_Pointer, uint16_t ReadSize, uint32_t ReadAddress){
        SPI_APP_Buffer_Read(SPI_Class_2, uint8_t* input_Pointer, uint16_t ReadSize, uint32_t ReadAddress);
    }
    void SPI_2_Write(uint8_t* input_Pointer, uint16_t WriteSize, uint32_t WriteAddress){
        SPI_APP_Buffer_Write(SPI_Class_2, uint8_t* input_Pointer, uint16_t WriteSize, uint32_t WriteAddress);
    }
...
#define __SPI__Register__Reference__
    ...
    static uint16_t SPI_Register_Timeout(SPI_Class_Struct input_SPI_Class, uint8_t input_Message){
        /* 等待超时后的处理,输出错误信息 */
