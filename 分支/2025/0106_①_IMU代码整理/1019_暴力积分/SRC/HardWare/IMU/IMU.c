...
#ifdef alpha_before_pid
    for(imu_i = 0; imu_i < 3; imu_i++){
      accel[imu_i] = alpha * (s16Accel[imu_i] - 0) + (1 - alpha) * accel[imu_i];
    }
#endif
