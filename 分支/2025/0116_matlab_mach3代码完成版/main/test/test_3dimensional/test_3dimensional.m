        ...
        % 计算 & 状态
            if flag_calc == 1
                ...
                % 计算
                    ...
                    for i = 1:3
                        % input_data = all_data( index_move_start:index_move_finish , i );
                        input_mean  = mean( all_data((index_while - 2*scan_move_avg_size : index_while - scan_move_avg_size) , i) );

                        input_start = index_move_start;
                        input_finish= index_move_finish;
                        input_judge_stop_times = judge_stop_times;
                        output_map = ukf_3dimensional(all_data(:,i), input_start, input_finish, input_mean, input_judge_stop_times);
