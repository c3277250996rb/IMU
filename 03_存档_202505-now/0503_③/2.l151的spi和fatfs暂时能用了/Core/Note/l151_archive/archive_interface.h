/**
 * @brief 正点原子 I2C 驱动 [All]
 */

#ifndef Alientek_I2C_All_arc_def
#define Alientek_I2C_All_arc_def
...
/**
 * @brief 微雪 I2C 驱动 [仅Driver]
 */

#ifndef Waveshare_I2C_APP_Driver_arc_def
#define Waveshare_I2C_APP_Driver_arc_def

            /**
             * @brief 直接用 正点原子 的 Definition
             */
