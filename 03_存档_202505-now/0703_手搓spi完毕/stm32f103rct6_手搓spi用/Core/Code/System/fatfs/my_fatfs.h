...
#if sFLASH_ID == F_F_W25Q16
    #define FATFS_SECTOR_OFFSET_DIVISOR 0
    #define FATFS_SECTOR_COUNT_DIVISOR  0
#elif sFLASH_ID == F_F_W25Q32
    #define FATFS_SECTOR_OFFSET_DIVISOR 0.5
    #define FATFS_SECTOR_COUNT_DIVISOR  0.5
#elif sFLASH_ID == F_F_W25Q64
    #define FATFS_SECTOR_OFFSET_DIVISOR 0.5
    #define FATFS_SECTOR_COUNT_DIVISOR  1.5
#elif sFLASH_ID == F_F_W25Q128
    #define FATFS_SECTOR_OFFSET_DIVISOR 1.5
    #define FATFS_SECTOR_COUNT_DIVISOR  2.5
#endif
...
// fatfs config
    ...
    // F103
        // #define is_embedfire_offset 0
        // #define is_embedfire_count 0
        #define is_embedfire_offset 2
        #define is_embedfire_count -2
        /* 扇区偏移6MB，外部Flash文件系统空间放在SPI Flash后面10MB空间 */
        #define FATFS_SECTOR_OFFSET 1024 * FATFS_SECTOR_OFFSET_DIVISOR + is_embedfire_offset
        /* 扇区数量：2560*4096/1024/1024=10(MB) */
        #define FATFS_SECTOR_COUNT  1024 * FATFS_SECTOR_COUNT_DIVISOR + is_embedfire_count
    ...
    // L151
        /* 扇区偏移6MB，外部Flash文件系统空间放在SPI Flash后面10MB空间 */
        #define FATFS_SECTOR_OFFSET 1024 * FATFS_SECTOR_OFFSET_DIVISOR
        /* 扇区数量：2560*4096/1024/1024=10(MB) */
        #define FATFS_SECTOR_COUNT  1024 * FATFS_SECTOR_COUNT_DIVISOR
