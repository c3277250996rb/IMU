...
/* APP Reference Begin */
    ...
    void I2C_APP_Init(void){
        ...
        HAL_GPIO_WritePin(I2C1_SCL_PB6_GPIO_Port, I2C2_SCL_PB10_Pin|I2C2_SDA_PB11_Pin|I2C1_SCL_PB6_Pin|I2C1_SDA_PB7_Pin, GPIO_PIN_SET);
      
        /*Configure GPIO pins : PBPin PBPin PBPin PBPin */
        GPIO_InitStruct.Pin = I2C2_SCL_PB10_Pin|I2C2_SDA_PB11_Pin|I2C1_SCL_PB6_Pin|I2C1_SDA_PB7_Pin;
        GPIO_InitStruct.Mode = 
            OD_for_1_and_PP_for_0 ? GPIO_MODE_OUTPUT_OD : GPIO_MODE_OUTPUT_PP;
