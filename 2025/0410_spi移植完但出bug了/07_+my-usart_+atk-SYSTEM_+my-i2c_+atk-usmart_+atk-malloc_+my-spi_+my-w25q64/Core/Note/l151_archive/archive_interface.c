...
#ifndef Alientek_I2C_All_arc_ref
#define Alientek_I2C_All_arc_ref
...
/**
 * @brief 微雪 I2C 驱动 [APP & Driver]
 */

#ifndef Waveshare_I2C_APP_Driver_arc_ref
#define Waveshare_I2C_APP_Driver_arc_ref
