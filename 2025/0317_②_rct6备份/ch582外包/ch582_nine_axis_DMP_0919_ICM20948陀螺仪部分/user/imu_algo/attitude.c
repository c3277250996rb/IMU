...
volatile float _error_integral_range_L=0;
volatile float _error_integral_range_H=0;
...
//参数初始化
	...
	attitude->parameter.correct_kp = 25.0f;//0.4f;
	_error_integral_range_L= -0.035f;
	_error_integral_range_H= 0.035f;
#elif 1  //5ms
    attitude->parameter.error_ki = 0.5f;
    attitude->parameter.error_kp = 2.5f;
    attitude->parameter.correct_kp = 25.0f;//0.4f;
    _error_integral_range_L=-10.0f;
    _error_integral_range_H=10.0f;
#endif
//中间变量清空
...
/////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	//积分限幅 -- 2°以内
	attitude->process.error_integral.x = LIMIT(attitude->process.error_integral.x, _error_integral_range_L ,_error_integral_range_H );
	attitude->process.error_integral.y = LIMIT(attitude->process.error_integral.y, _error_integral_range_L ,_error_integral_range_H );
	attitude->process.error_integral.z = LIMIT(attitude->process.error_integral.z, _error_integral_range_L ,_error_integral_range_H );
