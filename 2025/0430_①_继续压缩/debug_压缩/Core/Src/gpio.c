...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(LED_D4_PC2_GPIO_Port, LED_D4_PC2_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = LED_D4_PC2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LED_D4_PC2_GPIO_Port, &GPIO_InitStruct);
