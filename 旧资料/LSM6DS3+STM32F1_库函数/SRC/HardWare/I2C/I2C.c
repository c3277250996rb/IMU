...
// void I2C_SCL_Set(){GPIO_WriteBit(GPIOB, I2C_SCL_PIN, Bit_SET)	;}
// void I2C_SCL_Clr(){GPIO_WriteBit(GPIOB, I2C_SCL_PIN, Bit_RESET)	;}
// void I2C_SDA_Set(){GPIO_WriteBit(GPIOB, I2C_SDA_PIN, Bit_SET)	;}
// void I2C_SDA_Clr(){GPIO_WriteBit(GPIOB, I2C_SDA_PIN, Bit_RESET)	;}
// void I2C_SDA_Get(){GPIO_ReadInputDataBit(GPIOB, I2C_SDA_PIN)	;}
