...
#define I2C_SCL_Set()  GPIO_WriteBit(my_gpio, I2C_SCL_PIN, Bit_SET)
#define I2C_SCL_Clr()  GPIO_WriteBit(my_gpio, I2C_SCL_PIN, Bit_RESET)

#define I2C_SDA_Set()  GPIO_WriteBit(my_gpio, I2C_SDA_PIN, Bit_SET)
#define I2C_SDA_Clr()  GPIO_WriteBit(my_gpio, I2C_SDA_PIN, Bit_RESET)

#define I2C_SDA_Get()  GPIO_ReadInputDataBit(my_gpio, I2C_SDA_PIN)

static uint16_t I2C_SCL_PIN = GPIO_Pin_5;
static uint16_t I2C_SDA_PIN = GPIO_Pin_7;
static GPIO_TypeDef * my_gpio = GPIOA;
void switch_lq(int is_qmc);
